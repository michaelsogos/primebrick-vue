    ...
    <v-container fluid fill-height class="pa-0 ma-0 align-content-start flex-grow-1 flex-shrink-0">
        <h-panel>
            ...
            <v-data-table
                ...
                show-group-by
                show-select
                :single-select="!(view.definition.options.enableMultiSelect || false)"
...
export default {
    ...
    data: function () {
        return {
            ...
            showArchivedEntities: this.view.definition.showArchivedEntities
        };
    },
    computed: {
    ...
    methods: {
       ...
       */
        ...
        async deleteItems(ids) {
            /** @type {import("../../models/QueryResult").QueryResult} */
            const result = await this.$store.dispatch($.actions.APP_DELETE_ENTITIES, new DeleteOrArchiveOrRestoreEntities(this.view.brick, this.view.entity.name, ids));
        ...
        async archiveItems(ids) {
            /** @type {import("../../models/QueryResult").QueryResult} */
            const result = await this.$store.dispatch($.actions.APP_ARCHIVE_ENTITIES, new DeleteOrArchiveOrRestoreEntities(this.view.brick, this.view.entity.name, ids));
        ...
        async restoreItems(ids) {
            /** @type {import("../../models/QueryResult").QueryResult} */
            const result = await this.$store.dispatch($.actions.APP_RESTORE_ENTITIES, new DeleteOrArchiveOrRestoreEntities(this.view.brick, this.view.entity.name, ids));
        ...
        buildGridColumns() {
            ...
            for (const item of this.view.definition.fields) {
        ...
        */
        ...
        onAddFilter() {
            if (this.dialogFiltersSelectedField) {
                this.viewDialogFilters.push(Object.assign(new ViewFilterField, this.dialogFiltersSelectedField));
            }
        }
    },
    mounted() {
